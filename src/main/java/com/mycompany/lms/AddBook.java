...
public class AddBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("Z:\\My Campus Documents\\School_Mabagment_System\\LMS\\Book add.png")); // NOI18N
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        ...
        if(bookid.getText().isEmpty()){
            ...
            JOptionPane.showMessageDialog(null,"Plese Enter Book Name");
             ...
             JOptionPane.showMessageDialog(null,"Plese Enter Book Title");
        }else{
        ...
        try{
              String returnbook=" ";
              AddBookClass adding =new AddBookClass();
              int id=Integer.parseInt(bookid.getText());
              adding.Books( id,bookname.getText(), title.getText(),returnbook);
           
              bookid.setText(" ");
              bookname.setText(" "); //add book clear
              title.setText(" ");
